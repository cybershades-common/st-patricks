          ...
          <section class="section-padding-def text-center s-simple-txt">
            <div class="container container-anim-js position-relative z-index-1 s-simple-txt__container">
              ...
              <div class="s-simple-txt__txt-wrap mx-auto last-el-mb-0 children-batch-anim-js">
                <p>We believe education should shape <br> great minds and good hearts.</p>
                <p>Grounded in faith and guided by the Ignatian tradition, we challenge students to pursue academic excellence while growing in compassion, integrity and purpose.</p>
                <p>Here, every learner is known and supported. Students are encouraged to think deeply, act justly and use their gifts in service of others as they step into the world with confidence and hope.</p>
              </div>
            ...
            <div class="container container-anim-js s-cards__container">
              <div class="s-cards__heading mx-auto text-center last-el-mb-0">
                ...
                <div class="s-cards__txt-wrap body-2 last-el-mb-0 batch-item-js batch-item--static-js">
                  <p>Inspired by the Gospels, and in the spirit of John XXIII, Mary Ward and St Ignatius of Loyola, we seek to be people of competence, conscience and compassion who are committed to God and the service of others.</p>
                </div>
              </div>
                ...
                <div class="swiper-wrapper s-full-slider__txt-slider-wrapper">
                  ...
                  $slides_txt = [
                    [
                      ...
                      'text' => '<p>Students grow in heart, mind, body and spirit. Cura personalis, the care of the whole person, anchors our teaching, wellbeing and community life. Students feel known, safe and supported as they become confident, thoughtful young people.</p>',
                      'link_text' => 'Our Wellbeing Approach'
                    ],
                    [
                      'kicker' => 'WHY families choose us',
                      'title' => 'Education in the Ignatian tradition',
                      'text' => '<p>The College lives its mission each day through reflection, liturgy, service, retreats and formation programs. Students learn to recognise God in daily moments and to respond with generosity and integrity.</p>',
                    ...
                    [
                      ...
                      'text' => '<p>More than one hundred opportunities in arts, sport, leadership, music, service, coding, sustainability and community clubs help students discover passions and friendships that last.</p>',
                      'link_text' => 'VIEW Co-Curricular Opportunities'
                    ],
                    [
                      'kicker' => 'WHY families choose us',
                      'title' => 'A community that feels like home',
                      'text' => '<p>Families, staff, students and alumni create a warm and generous community that stands together. Education becomes a shared journey that strengthens families and forms future leaders.</p>',
                      'link_text' => 'Join Our Community'
                    ],
                    [
                      'kicker' => 'WHY families choose us',
                      'title' => 'A stunning Campus That Inspires Learning',
                      'text' => '<p>Set among open green spaces and purpose built facilities, our campus feels more like a university than a school. It invites students to think expansively, learn with confidence and feel proud of where they belong.</p>',
              ...
              <div class="s-pre-k__heading d-flex flex-wrap mx-auto align-items-start">
                ...
                <div class="s-pre-k__heading-col position-relative s-pre-k__heading-col--2 col-lg-6 last-el-mb-0">
                  ...
                  <div class="s-pre-k__txt-wrap last-el-mb-0 body-3 batch-item--static-js batch-item-js">
                    <p>From first steps to graduation, students can join John XXIII College at key stages, growing in learning, faith and belonging within one connected and caring community.</p>
                  </div>
                  ...
                  <div class="swiper-wrapper s-pre-k__txt-slider-wrapper">
                    ...
                    $slides_2_txt = [
                      [
                        ...
                        'text' => '<p>The journey begins with wonder. In our early years, children learn through play, imagination and gentle guidance. They feel safe, known and joyful as they discover friendships, curiosity and the first steps of learning grounded in care and faith.</p>',
                        'btn_text' => 'Explore Early Learning'
                      ],
                      [
                        'kicker' => 'Pre-Primary to Year 4',
                        'title' => 'Lower Primary',
                        'text' => '<p>Strong foundations take shape here. Students develop core skills in literacy and numeracy while building confidence, independence and a love of learning. Through encouragement and care, each child grows in curiosity and self belief.</p>',
                        'btn_text' => 'Explore Lower Primary'
                      ],
                      [
                        'kicker' => 'Years 5–6',
                        'title' => 'Upper Primary',
                        'text' => '<p>As independence grows, so does responsibility. Students are challenged to think more deeply, take ownership of their learning and strengthen leadership skills. This stage prepares them academically and emotionally for the transition ahead.</p>',
                        'btn_text' => 'Explore Upper Primary'
                      ],
                      [
                        'kicker' => 'Transition to Year 7',
                        'title' => 'Transition',
                        'text' => '<p>Change is guided with care. Our transition program supports students as they move into Secondary School, building confidence, belonging and readiness. Strong relationships and clear structures help students step forward with assurance.</p>',
                      ...
                      [
                        ...
                        'text' => '<p>Purpose comes into focus. Students refine their academic pathways, prepare for life beyond school and grow as leaders of integrity. With high expectations and strong support, they graduate ready to serve, lead and thrive in the world.</p>',
                ...
                <div class="s-pre-k__blocks-swiper w-100 slider-thumbs-3-js swiper overflow-visible">
                  <div class="swiper-wrapper s-pre-k__blocks-swiper-wrapper justify-content-xl-center">
                    ...
                    $slides_3_thumb = [
                      [
                        'title' => 'Early Learning',
                        'text' => 'Pre Kindy and Kindy (Ages 3-5)',
                        'pic' => 'index-11.webp',
                      ],
                      [
                        'title' => 'Lower Primary',
                        'text' => 'Pre-Primary to Year 4',
                        'pic' => 'index-12.webp',
                      ],
                      [
                        'title' => 'Upper Primary',
          ...
          <section class="section-padding-def s-results">
            <div class="container container-anim-js s-results__container position-relative z-index-1">
              ...
              <div class="s-results__heading text-center mx-auto last-el-mb-0">
                ...
                <h2 class="s-results__title h3 color-1 batch-item-js batch-item--text-js split-text-init-js split-text-lines-js">Rigorous learning, exceptional results</h2>
                <div class="s-results__txt-wrap body-2 last-el-mb-0 batch-item-js batch-item--static-js">
                  <p>We teach our students to relentlessly question, think innovatively and stay abreast of an ever changing world. Together, we strive for greatness and to rise to the challenges of our times.</p>
                </div>
              </div>
              <?php
              $results = [
                [
                  'value' => '80%+',
                  'text' => '<p>of eligible students studying Religion and Life ATAR include it in their final WACE subject selection.</p>'
                ],
                [
                  'value' => '150+',
                  'text' => '<p>co-curricular teams, programs and clubs offered across sport, arts, service, leadership and enrichment.</p>'
                ],
                [
                  'value' => '100%',
                  'text' => '<p>of students participate in age-appropriate faith formation, reflection or service programs from Primary to Year 12.</p>'
                ],
                [
                  'value' => '100%',
                  'text' => '<p>of students participate in age-appropriate faith formation, reflection or service programs from Primary to Year 12.</p>'
              ...
              <div class="s-offering__heading d-flex flex-wrap mx-auto">
                ...
                <div class="s-offering__heading-col position-relative s-offering__heading-col--2 col-6 last-el-mb-0">
                  ...
                  <div class="s-offering__txt-wrap last-el-mb-0 body-3 batch-item--static-js batch-item-js">
                    <p>Discover your passion and talents outside the classroom with our extensive co-curricular opportunities.</p>
                  </div>
              ...
              <div class="swiper cards-swiper-js overflow-visible s-offering__swiper">
                <div class="swiper-wrapper s-offering__swiper-wrapper">
                  ...
                  $cards_2 = [
                    [
                      'title' => 'Sport',
                      'text' => '<p>There’s plenty of team and individual sports to try as well as representative opportunities. What will yours be?</p>',
                ...
                <div class="s-slider-quote__block-col s-slider-quote__block-col--1 d-flex flex-column">
                  <div class="s-slider-quote__swiper slider-contents-2-js swiper overflow-visible">
                    <div class="swiper-wrapper s-slider-quote__swiper-wrapper">
                      ...
                      $quotes = [
                        [
                          'text' => '<p>“John XXIII College has outstanding academics, phenomenal athletic and arts programs and every resource needed to grow, learn and prepare students for success.”</p>',
                          'name' => 'Ally Cooper',
                          'pos' => 'Year 9 Student',
                        ],
                        [
                          'text' => '<p>“Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis, nemo.”</p>',
                          'name' => 'Lorem ipsum.',
                          'pos' => 'Year 7 Student',
                        ],
                      ];
            ...
            <div class="container container-anim-js s-soc-feed__container">
              <div class="s-soc-feed__heading last-el-mb-0 mx-auto w-100 text-center">
                ...
                <div class="s-soc-feed__txt-wrap last-el-mb-0 body-3 batch-item--static-js batch-item-js">
                  <p>A leading Catholic, independent, co-educational College where academic and personal excellence, along with the commitment to serve others and seek justice, are the aspirations of every student.</p>
                </div>
